	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
							<form id="form_import" action="importContent.htm" method="post" enctype="multipart/form-data">
							<input type="file" name="conname">
							</form>
				</div>
				<div class="modal-footer">
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	if(res.success){
	    			    		res.elist.forEach(function(emp){
	    			    			xAxis.push(emp.cname);
	    			    			yAxis.push({value:emp.num,name:emp.cname});
		    			    	})
		    			    	option = {
    			    			    xAxis: {
    			    			        type: 'category',
