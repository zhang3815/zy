...
<body class="gray-bg">
	...
	<div class="modal fade" id="modal_user_stu" role="dialog" aria-labelledby="modal_user_stu" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					 <h4 class="modal-title" id="modal_user_del_head">添加专业  </h4>
				</div>
				<div class="modal-body">
						专业	<form action="teacherStu.htm" id="form_stu" method="post">
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
							<form action="importStudent.htm" id="form_import" method="post" enctype="multipart/form-data">
    			    ...
    			    success:function(res){
    			    	...
    			    	if(res.success){
    			    	 	res.elist.forEach(function(emp){
	    			    		xdata.push(emp.canme);
	    			    		ydata.push({value:emp.num,name:emp.canme});
	    			    	})
	    			    	option = {
    			    		    title: {
    			    		        text: '某站点用户访问来源',
