...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">学生吃</span>
					...
					<form id="form_user" method="post" action="reserveUser.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>学生性别：</td>
								<td><select class="form-control" name="gender" id = "gender" aria-required="true" required>
							...
							<tr>
								...
								<td>学生头像：</td>
								<td>
<!-- 								<img alt="" id="pics" src="" width="100px" height="100px"> -->
