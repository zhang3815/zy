...
private TbstudayMapper tbstudayMapper;
	...
	public PageInfo<TbVo> findUserPage(TbVo tbVo, int pageNum, int pageSize) {
		...
		List<TbVo> list = tbstudayMapper.findPage(tbVo);
		PageInfo<TbVo> pageInfo = new PageInfo<TbVo>(list);
		return pageInfo;
	}
	// 新增
	public void addUser(TbVo t) throws Exception {
		tbstudayMapper.insert(t);
	};

	// 修改
	public void updateUser(TbVo t) throws Exception {
